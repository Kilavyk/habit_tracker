...
class HabitSerializer(serializers.ModelSerializer):
    ...
    Provides:
        - Полная сериализация всех полей привычки
        - Автоматическое определение пользователя из запроса
        - Валидация бизнес-правил привычек

    Validation Rules:
        - Длительность не более 120 секунд
        - Периодичность не реже раза в неделю (не более 7 дней)
        - Приятные привычки не могут иметь вознаграждения или связанных привычек
        - Взаимное исключение вознаграждения и связанной привычки
